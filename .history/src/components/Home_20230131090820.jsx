  ...
  return (
    <div name="home" className="w-full h-screen bg-[#F2EDEB]">
      ...
      <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
        <h4 className="text-[#C94277] font-semibold">Hi, my name is</h4>
        ...
        <p className="text-[#2B2B46] py-4 max-w-[700px]">
          After 6 years of working in the fitness industry I chose to pursue a
          new career path into Software Development because I was ready to
          diversify my skillset and face new challenges.
        </p>
